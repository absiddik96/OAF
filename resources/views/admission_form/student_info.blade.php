...
<div class="form-group form-float">
    <div class="">
        ...
        {!! Form::radio('gender', 1, null, ['class'=>'radio-col-deep-purple','required'=>'','id'=>'radio_9']) !!}
        <label for="radio_9">Male</label>
        {!! Form::radio('gender', 2, null, ['class'=>'radio-col-deep-purple','required'=>'','id'=>'radio_10']) !!}
...
<div class="form-group form-float">
    <div class="">
        ...
        {!! Form::select('blood_group', [''=>'Choose']+$blood_group, null, ['class'=>'form-control','required'=>'']) !!}
    </div>
</div>
...
<div class="form-group form-float">
    <div class="form-line">
        {!! Form::textarea('present_address', null, ['class'=>'form-control no-resize','required'=>'','size'=>'30x3']) !!}
...
<div class="form-group form-float">
    <div class="form-line">
        {!! Form::textarea('permanent_address', null, ['class'=>'form-control no-resize','required'=>'','size'=>'30x3']) !!}
