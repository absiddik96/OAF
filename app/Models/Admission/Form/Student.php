...
class Student extends Model
{
    ...
    protected $fillable = ['name' ,'dob', 'gender', 'photo', 'blood_group', 'email', 'contact_number', 'present_address', 'permanent_address', 'nationality', 'religion',  'signature','reg_token','department_id','status','exam_season_id'];
