...
class AdmissionFormCreateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'photo'             => 'required|image|mimes:jpeg,png,jpg|max:300|dimensions:width=300,height=300',
            ...
            'signature'         => 'required|image|mimes:jpeg,png,jpg|max:300|dimensions:width=500,height=200',
            ...
            'father_photo'      => 'required|image|mimes:jpeg,png,jpg|max:300|dimensions:width=300,height=300',
            'mother_name'       => 'required|min:3|max:100',
            'mother_occupation' => 'required|min:3|max:100',
            'mother_contact'    => 'required|min:8',
            'mother_photo'      => 'required|image|mimes:jpeg,png,jpg|max:300|dimensions:width=300,height=300',

            // // guardian info
            'guardian_name'           => 'required|min:3|max:100',
            'guardian_photo'          => 'required|image|mimes:jpeg,png,jpg|max:300|dimensions:width=300,height=300',
            ...
            'guardian_signature'      => 'required|image|mimes:jpeg,png,jpg|max:300|dimensions:width=500,height=200',
        ];
    }
}
